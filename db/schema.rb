...
ActiveRecord::Schema[8.1].define(version: 2026_09_26_151430) do
  ...
  create_table "groups", force: :cascade do |t|
    ...
    t.string "name", null: false
    t.datetime "updated_at", null: false
    t.index ["discord_guild_id"], name: "index_groups_on_discord_guild_id", unique: true
